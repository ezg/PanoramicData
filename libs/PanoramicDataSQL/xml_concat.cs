...
public struct xml_concat : IBinarySerialize 
{
    ...
    {
        IntermediateResult.Add("<e><![CDATA[" + Value.ToString() + "]]></e>");
    }

    public void Merge (xml_concat Group)
    {
    ...
    public SqlString Terminate ()
    {
        ...
        return "<row>" + string.Join("", IntermediateResult.ToArray()) + "</row>";
    }
