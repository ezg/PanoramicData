...
namespace SharpGL.RenderContextProviders
{
    public class FBORenderContextProvider : HiddenWindowRenderContextProvider
    {
        ...
        public override bool Create(OpenGL gl, int width, int height, int bitDepth, object parameter)
        {
            ...
            gl.RenderbufferStorageEXT(OpenGL.GL_RENDERBUFFER_EXT, OpenGL.GL_RGBA, width, width);
            //gl.RenderbufferStorageMultisampleEXT(OpenGL.GL_RENDERBUFFER_EXT, 16, OpenGL.GL_RGBA, width, width);
        ...
        public override void Blit(IntPtr hdc)
        {
            ...
            {
                //  Set the read buffer.
                //gl.ReadBuffer(OpenGL.GL_COLOR_ATTACHMENT0_EXT); ez: commented out 
