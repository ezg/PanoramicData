...
namespace SharpGL
{
    public partial class OpenGL
    {
        ...
        {
            InvokeExtensionFunction<glTexImage2DMultisample>(target, samples, internalformat, width, height, fixedsamplelocations);
        }
        ...
        public void BlitFramebufferEXT(int srcX0, int srcY0, int srcX1, int srcY1, 
        ...
        private delegate void glBlitFramebufferEXT(int srcX0, int srcY0, int srcX1, int srcY1,
            int dstX0, int dstY0, int dstX1, int dstY1, uint mask, uint filter);
