...
namespace Microsoft.Research.DynamicDataDisplay.Charts
{
	public sealed class NumericTicksProvider : ITicksProvider<double> {
        public NumericTicksProvider() : this(10) { } // bcz: added
		public NumericTicksProvider(double units)
		{
		...
		public ITicksInfo<double> GetTicks(Range<double> range, int ticksCount) {
            double start = range.Min / TickUnits; // bcz: modified
            double finish = range.Max / TickUnits; // bcz: modified
